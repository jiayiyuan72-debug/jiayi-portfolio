...
export function defaultCanvasNode(type: CanvasType): CanvasNode {
  ...
  switch (type) {
    ...
    case 'memory-card':
      return { id, type, props: { ...baseProps, height: '240px', bgColor: '#f8f5f0', borderRadius: 12, paddingTop: 0, paddingRight: 0, paddingBottom: 0, paddingLeft: 0 }, content: { title: '记忆卡片', subtitle: '点击查看详细内容', icon: '🎴', coverImage: '', canvasData: [] }, children: [] };
  }
}
